        ...
        <div className="bg-[#111827]">
          ...
          >
            <div className="flex items-center justify-center w-full h-full bg-gray-900/40">
              ...
              incidents and violations acted as a catalyst for our collective
              determination. Faced with this growing urgency, our team embarked
              on a purposeful journey, committed to crafting a transformative
            ...
            <p className="text-base font-medium font-[Montserrat] text-gray-300 lg:w-[95%]">
              ...
              culture of compliance and safety on the roads. The overwhelming
              complexity of traffic management became an opportunity for us to
              contribute to a safer, more responsible road environment. Today,
              [Your Website Name] stands as a testament to our enduring
              commitment to shaping a better and safer future for all road
              users.
            </p>
                </p>
              </div>
