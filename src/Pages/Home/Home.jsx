  ...
  return (
    <div className="bg-[#111827]">
      <Layout>
        ...
        {/*  */}
        <div className="text-center bg-[#111827] reveal-element">
          ...
          <div className="px-8 sm:items-start sm:justify-center sm:px-0 sm:space-x-5 sm:flex mt-9 reveal-element">
            <Link
              to="/signin"
              title=""
              className="mb-3 sm:mb-0 inline-flex items-center justify-center w-full px-8 py-3 text-lg font-bold text-white transition-all duration-200 bg-gray-800 border-2 border-transparent sm:w-auto rounded-xl font-pj hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 font-[Fahkwang]"
              role="button"
            >
              Get Started
            </Link>
