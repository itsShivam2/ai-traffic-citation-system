      ...
      <section class="py-12 bg-gray-900 text-gray-100 sm:py-16 lg:py-20">
        <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          <div class="max-w-xl mx-auto text-center xl:max-w-2xl">
            <h2 class="text-3xl font-bold font-[Fahkwang] leading-tight sm:text-4xl xl:text-5xl font-pj reveal-element">
              Technologies Used
            </h2>
          </div>
          ...
          <div class="grid max-w-4xl lg:max-w-6xl grid-cols-1 mx-auto mt-8 text-center gap-y-4 sm:gap-x-8 sm:grid-cols-2 lg:grid-cols-3 sm:mt-12 lg:mt-20 sm:text-left">
            <div class="overflow-hidden bg-gray-800 shadow-md rounded-xl text-center reveal-element">
              <div class="p-9">
                ...
                <h3 class="mt-6 text-2xl font-[Fahkwang] font-bold sm:mt-10 font-pj">
                  YOLO v3
                </h3>
                {/* <h3 class="mt-6 text-2xl font-bold sm:mt-10 font-pj">
                  License Plate Detection in Images
                </h3> */}
                <p class="mt-6 text-base text-gray-300 font-pj font-[Montserrat]">
            ...
            <div class="relative text-center reveal-element">
              ...
              <div class="relative overflow-hidden bg-gray-800 shadow-md rounded-xl h-full">
                <div class="p-9">
                  ...
                  <h3 class="mt-6 text-2xl font-bold font-[Fahkwang] sm:mt-10 font-pj">
                    YOLO v8
                  </h3>
                  {/* <h3 class="mt-6 text-2xl font-bold sm:mt-10 font-pj">
