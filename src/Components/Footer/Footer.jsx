...
function Footer() {
  return (
    <div>
      <footer className="w-full bg-[#000000] text-white  py-16">
        <div className="md:px-12 lg:px-28">
          <div className="container m-auto space-y-6 text-gray-600 dark:text-gray-300">
            ...
            >
              <li role="listitem">
                <Link to="/" className="hover:text-primary text-white">
                  Home
                </Link>
              </li>
              ...
              <li role="listitem">
                <Link href="/admin" className="hover:text-primary text-white">
                  Update Challan
                </Link>
              </li>
              <li role="listitem">
            ...
            <div className="m-auto flex w-max items-center justify-between space-x-4">
              <a href="tel:+911234567890" aria-label="call">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="currentColor"
                  className="m-auto w-5 text-white"
                  viewBox="0 0 16 16"
                >
                  <path
                    fillRule="evenodd"
            ...
            <div className="text-center">
              <span className="text-sm tracking-wide text-white">
                Copyright © AI Traffic Citation Services <span id="year"></span>{" "}
                | All right reserved
              </span>
            </div>
          </div>
